...
public class Users extends javax.swing.JPanel {
    ...
    private void InitStyles() {
        ...
        userSearch.putClientProperty("JTextField.placeholderText", "Insira o nome do usuraio para Buscar.");
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "Primeiro s.", "Segundo s.", "Endereço", "Telefone"
            }
        ) {
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        if (jTable1.getSelectedRows().length < 1) {
            javax.swing.JOptionPane.showMessageDialog(this, "Deve selecionar um ou mais para apagar.\n", "AVISO", javax.swing.JOptionPane.ERROR_MESSAGE);
        } else {
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        if (jTable1.getSelectedRow() > -1) {
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Deve selecionar usuraio para editar.\n", "AVISO", javax.swing.JOptionPane.ERROR_MESSAGE);
        }
