...
public class UpUsers extends javax.swing.JPanel {
    ...
    private void InitStyles() {
        ...
        nameTxt.putClientProperty("JTextField.placeholderText", "Insira o nome do usuario.");
        apPTxt.putClientProperty("JTextField.placeholderText", "Insira o promeiro sobrenome do usuario.");
        apMTxt.putClientProperty("JTextField.placeholderText", "Insira o ultimo sobrenome do usuario.");
        domTxt.putClientProperty("JTextField.placeholderText", "Insira o endereço do usuario.");
        phoneTxt.putClientProperty("JTextField.placeholderText", "Insira o telefone do usuario.");
    ...
    private void initComponents() {
        ...
        title.setText("Registrar novo Usuario");

        nameLbl.setText("Nome");

        apPLbl.setText("Primeiro sobrenome");

        apMLbl.setText("Último sobrenome");

        jSeparator1.setForeground(new java.awt.Color(204, 204, 204));
        jSeparator1.setOrientation(javax.swing.SwingConstants.VERTICAL);
        jSeparator1.setPreferredSize(new java.awt.Dimension(200, 10));

        domLbl.setText("Endereço");
    ...
    private void buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonActionPerformed
        ...
        if (nombre.isEmpty() || apP.isEmpty() || apM.isEmpty() || dom.isEmpty() || tel.isEmpty()) {
            javax.swing.JOptionPane.showMessageDialog(this, "Deve preencher tudoi. \n", "AVISO", javax.swing.JOptionPane.ERROR_MESSAGE);
        ...
        try {
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Usuario " + successMsg + " existente.\n", "AVISO", javax.swing.JOptionPane.INFORMATION_MESSAGE);
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Ocorreu um erro com " + errorMsg + " esse usuario. \n", "AVISO", javax.swing.JOptionPane.ERROR_MESSAGE);
