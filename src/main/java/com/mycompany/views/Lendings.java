...
public class Lendings extends javax.swing.JPanel {
    ...
    private void InitStyles() {
        ...
        libroIdTxt.putClientProperty("JTextField.placeholderText", "Insira o ID do Livro para Emprestar.");
    }
    ...
    private void initComponents() {
        ...
        folioLbl.setText("Nome de Usuario");
    ...
    private void buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonActionPerformed
        ...
        if (folio.isEmpty() || bookId.isEmpty()) {
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Campo do nome e o do ID do Livro devem ser numeiros inteiros. \n", "AVISO", javax.swing.JOptionPane.ERROR_MESSAGE);
            folioTxt.requestFocus();
            return;
        } else if (Integer.parseInt(folio) <= 0 || Integer.parseInt(bookId) <= 0) {
            javax.swing.JOptionPane.showMessageDialog(this, "Campo do nome e o ID do Livro deve ser maior que 0. \n", "AVISO", javax.swing.JOptionPane.ERROR_MESSAGE);
            folioTxt.requestFocus();
            return;
        }
        ...
        try {
            ...
            if (currentUser == null) {
                javax.swing.JOptionPane.showMessageDialog(this, "Não existe usuario com esse nome. \n", "AVISO", javax.swing.JOptionPane.ERROR_MESSAGE);
                folioTxt.requestFocus();
                return;
            }
            ...
            if (currentBook == null){
                javax.swing.JOptionPane.showMessageDialog(this, "Não existe ID desse livro. \n", "AVISO", javax.swing.JOptionPane.ERROR_MESSAGE);
                libroIdTxt.requestFocus();
                return;
            }
            // Validamos disponibilidad del libro.
            else if (currentBook.getAvailable() < 1) {
                javax.swing.JOptionPane.showMessageDialog(this, "Não há mais Livros com esse ID para emprestar. \n", "AVISO", javax.swing.JOptionPane.ERROR_MESSAGE);
                libroIdTxt.requestFocus();
                return;
            }
            ...
            if (currentLending != null) {
                javax.swing.JOptionPane.showMessageDialog(this, "Essa Pessoa já está com o Livro solicitado. \n", "AVISO", javax.swing.JOptionPane.ERROR_MESSAGE);
                libroIdTxt.requestFocus();
                return;
            }
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Livro ID: " + currentBook.getId() + " Emprestado a " + currentUser.getName() + ".\n", "AVISO", javax.swing.JOptionPane.INFORMATION_MESSAGE);
            folioTxt.setText("");
            libroIdTxt.setText("");
        } catch (Exception e) {
            javax.swing.JOptionPane.showMessageDialog(this, "Ocorreu um erro com o ID do Livro. \n", "AVISO", javax.swing.JOptionPane.ERROR_MESSAGE);
