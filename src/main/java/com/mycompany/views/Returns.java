...
public class Returns extends javax.swing.JPanel {
    ...
    private void InitStyles() {
        ...
        folioTxt.putClientProperty("JTextField.placeholderText", "Insira o nome de Usuario.");
        libroIdTxt.putClientProperty("JTextField.placeholderText", "Insira o ID do Livro para Devolver.");
    }
    ...
    private void initComponents() {
        ...
        title.setText("Devolução de Livro");

        folioLbl.setText("Fatura de Usuario");

        libroIdLbl.setText("ID do Livro");
    ...
    private void buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonActionPerformed
        ...
        if (folio.isEmpty() || bookId.isEmpty()) {
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Todos os campos devem estar preenchidos. \n", "AVISO", javax.swing.JOptionPane.ERROR_MESSAGE);
            folioTxt.requestFocus();
            return;
        } else if (Integer.parseInt(folio) <= 0 || Integer.parseInt(bookId) <= 0) {
            javax.swing.JOptionPane.showMessageDialog(this, "todos os campos de ID devem ser maior que 0. \n", "AVISO", javax.swing.JOptionPane.ERROR_MESSAGE);
            folioTxt.requestFocus();
            return;
        }
        ...
        try {
            ...
            if (currentUser == null) {
                javax.swing.JOptionPane.showMessageDialog(this, "Não se encontrou ninguem com esse nome. \n", "AVISO", javax.swing.JOptionPane.ERROR_MESSAGE);
                folioTxt.requestFocus();
                return;
            }
            ...
            if (currentBook == null){
                javax.swing.JOptionPane.showMessageDialog(this, "Não se encontrou nenhum ID desse livro. \n", "AVISO", javax.swing.JOptionPane.ERROR_MESSAGE);
            ...
            if (currentLending == null) {
                javax.swing.JOptionPane.showMessageDialog(this, "Não se pode encontrar o ID do Livro. \n", "AVISO", javax.swing.JOptionPane.ERROR_MESSAGE);
                libroIdTxt.requestFocus();
                return;
            }
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Livro ID: " + currentBook.getId() + " devolvido por " + currentUser.getName() + ".\n", "AVISO", javax.swing.JOptionPane.INFORMATION_MESSAGE);
            folioTxt.setText("");
            libroIdTxt.setText("");
            ...
            if (days > MAX_DAYS_RETURN) {
                ...
                javax.swing.JOptionPane.showMessageDialog(this, "Usuario Multado por atraso! ($" + sancMoney + ") \n", "AVISO", javax.swing.JOptionPane.INFORMATION_MESSAGE);
            }
        } catch (Exception e) {
            javax.swing.JOptionPane.showMessageDialog(this, "Ocorreu um erro ao devolver. \n", "AVISO", javax.swing.JOptionPane.ERROR_MESSAGE);
