...
public class Principal extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Sistema de gerenciamento de Biblioteca. Controle e gestão de");

        jLabel3.setText("forma ótima, de fácil manuseio de empréstimos e devolução.");

        jLabel4.setText("Esta ferramenta le permite ter um controle completo.");

        jLabel5.setText("Tendo acesso a ferramentas de manuseio como:");

        jLabel6.setText("• Empréstimos");

        jLabel7.setText("• Devolução");

        jLabel8.setText("• Registro de Usuarios e Livros");

        jLabel9.setText("• Edição de Usuarios e Livros existentes");

        jLabel10.setText("• Eliminar todo tipo de Registro");

        jLabel11.setText("• Seção de Reportes de ações no sistema");
