...
public class Dashboard extends javax.swing.JFrame {
    ...
    private void SetDate() {
        ...
        dateText.setText(now.format(DateTimeFormatter.ofPattern("'Hoje é' EEEE dd 'de' MMMM 'de' yyyy", brazilLocale)));
    }
    ...
    private void initComponents() {
        ...
        mensaje.setText("Trabralhando ♥  feito condenado");
